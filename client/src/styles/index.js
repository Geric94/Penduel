const styles = {
  // general
  headText: 'font-rajdhani font-bold text-white sm:text-6xl',
  ...
  battleGroundCard: 'padding :20px; margin-up:20px sm:w-[420px] w-full h-[260px] p-2 glass-morphism m-4 rounded-lg cursor-pointer battle-card',
